...
public class QuizController {
    ...
    public ResponseEntity<QuizDetailsOutboundDto> getQuizDetailsByUserQuizId(@PathVariable UUID userId, @PathVariable UUID quizId) {
    ...
    public ResponseEntity<Page<QuizRequestDto>> getQuizRequestsByUserId(@PathVariable UUID userId, @RequestParam(required = false) QuizRequest.Status status, Pageable pageable) {
